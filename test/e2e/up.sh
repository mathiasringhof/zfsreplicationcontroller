...
kubectl_cmd label node "${WORKER_A}" zfsreplication.ringhof.io/enabled=true --overwrite
kubectl_cmd label node "${WORKER_B}" zfsreplication.ringhof.io/enabled=true --overwrite
